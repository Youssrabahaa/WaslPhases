...
namespace phase_1.Migrations
{
    ...
    [Migration("20260626090850_AddConversationAndMessages")]
            ...
            modelBuilder.Entity("phase_1.DAL.Models.Message", b =>
                {
                    ...
                    b.HasOne("phase_1.Models.ApplicationUser", "ReceiverUser")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("ReceiverUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("phase_1.Models.ApplicationUser", "SenderUser")
